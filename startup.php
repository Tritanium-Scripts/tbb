...
require_once('classes/templates.class.php'); // Die Templateklasse
require_once('classes/navbar.class.php'); // Die Templateklasse
...
//
$NAVBAR = new Navbar();
$NAVBAR->createArea('left','&nbsp;&#187;&nbsp;');
$NAVBAR->createArea('center','&nbsp;|&nbsp;',1);
$NAVBAR->createArea('right','&nbsp;|&nbsp;',1);
