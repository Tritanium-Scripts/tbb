...
switch(@$_GET['mode']) {
	default:
		$ad_ranks_tpl = new template;
		$ad_ranks_tpl->load($template_path.'/'.$tpl_config['tpl_ad_ranks_index']);
		...
		else $ad_ranks_tpl->unset_block('nrankrow');
		...
		else $ad_ranks_tpl->unset_block('srankrow');
	...
	case 'addrank':
		...
		$ad_ranks_tpl = new template;
		$ad_ranks_tpl->load($template_path.'/'.$tpl_config['tpl_ad_ranks_addrank']);

		if($error != '') $ad_ranks_tpl->blocks['errorrow']->parse_code();
		else $ad_ranks_tpl->unset_block('errorrow');
	...
	case 'editrank':
		...
		$ad_ranks_tpl = new template;
		$ad_ranks_tpl->load($template_path.'/'.$tpl_config['tpl_ad_ranks_editrank']);
