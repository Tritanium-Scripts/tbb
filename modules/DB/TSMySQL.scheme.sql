...
CREATE TABLE /*!32312 IF NOT EXISTS*/ "/*TABLEPREFIX*/forums" (
  ...
  "authUploadMembers" tinyint(1) unsigned NOT NULL default '0',
  "authDownloadMembers" tinyint(1) unsigned NOT NULL default '0',
  ...
  "authUploadGuests" tinyint(1) unsigned NOT NULL default '0',
  "authDownloadGuests" tinyint(1) unsigned NOT NULL default '0',
  PRIMARY KEY  ("forumID"),
  KEY "catID" ("catID"),
  KEY "orderID" ("orderID")
) /*!40100 DEFAULT CHARSET=utf8*/;
...
CREATE TABLE /*!32312 IF NOT EXISTS*/ "/*TABLEPREFIX*/forums_auth" (
  ...
  "authUpload" tinyint(1) unsigned NOT NULL default '0',
  "authDownload" tinyint(1) unsigned NOT NULL default '0',
...
CREATE TABLE /*!32312 IF NOT EXISTS*/ "/*TABLEPREFIX*/users" (
  ...
  "userAuthUpload" tinyint(1) unsigned NOT NULL default '2',
  "userAuthDownload" tinyint(1) unsigned NOT NULL default '2',
