...
class PlugIns
{
    ...
    public const HOOK_TPL_ADMIN_DELETE_OLD_FORM_BUTTONS = 'HOOK_TPL_ADMIN_DELETE_OLD_FORM_BUTTONS';
    ...
    public const HOOK_TPL_ADMIN_FORUM_FORUMS_TABLE_OPTIONS = 'HOOK_TPL_ADMIN_FORUM_FORUMS_TABLE_OPTIONS';
