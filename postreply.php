...
* Dient zum Schreiben einer Antwort in einem Thema
...
elseif($user_data['user_is_admin'] != 1) {
	if($forum_data['auth_members_post_reply'] != 1) {
		include_once('pheader.php');
...
$p_post = (isset($_POST['p_post']) ? mysslashes($_POST['p_post']) : '');
$p_title = (isset($_POST['p_title']) ? mysslashes($_POST['p_title']) : 'Re: '.$topic_data['topic_title']);
