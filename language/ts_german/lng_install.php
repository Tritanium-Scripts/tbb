...
$lng['existing_installation_unknown'] = 'Es konnte nicht festgestellt werden, um welche Version des Tritanium Bulletin Board 2 es sich dabei handelt. Wahrscheinlich sind die Daten besch‰digt oder es handelt sich gar nicht um eine Installation des Tritanium Bulletin Board 2. Sie k&ouml;nnen nun w&auml;hlen, ob sie eine andere Datenbankkonfiguration w&auml;hlen wollen (empfohlen) oder ob sie die vorhandenen Daten l&ouml;schen wollen.';
...
$lng['existing_installation_too_old'] = 'Es handelt sich dabei allerdings um eine &auml;ltere Version (<b>%s</b>), weswegen Sie diese Daten nicht verwenden k&ouml;nnen, ohne ein Update auf die aktuelle Version durchzuf&uuml;hren';
