		...
		case 'move':
			...
			if(isset($_GET['doit'])) {
				...
				if(!$target_forum_data = get_forum_data($p_target_forum_id)) $error = $lng['error_invalid_forum'];
					...
					include_once('pheader.php');
					show_navbar("<a href=\"index.php?$MYSID\">".$CONFIG['board_name']."</a>".get_navbar_cats($target_forum_data['cat_id'])."\r<a href=\"index.php?faction=viewforum&amp;forum_id=".$target_forum_data['forum_id']."&amp;$MYSID\">".myhtmlentities($target_forum_data['forum_name'])."</a>\r<a href=\"index.php?faction=viewtopic&amp;topic_id=$topic_id&amp;$MYSID\">".myhtmlentities($topic_data['topic_title'])."</a>\r".$lng['Move_topic']);
					show_message('Topic_moved','message_topic_moved','<br />'.sprintf($lng['click_here_moved_topic'],"<a href=\"index.php?faction=viewtopic&amp;topic_id=$topic_id&amp;$MYSID\">",'</a>'));
			...
			//
			$edittopic_tpl = new template;
			$edittopic_tpl->load($template_path.'/'.$tpl_config['tpl_edittopic_move']);
			...
			show_navbar("<a href=\"index.php?$MYSID\">".$CONFIG['board_name']."</a>".get_navbar_cats($forum_data['cat_id'])."\r<a href=\"index.php?faction=viewforum&amp;forum_id=$forum_id&amp;$MYSID\">".myhtmlentities($forum_data['forum_name'])."</a>\r<a href=\"index.php?faction=viewtopic&amp;topic_id=$topic_id&amp;$MYSID\">".myhtmlentities($topic_data['topic_title'])."</a>\r".$lng['Move_topic']);
