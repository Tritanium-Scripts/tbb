	...
	switch($mode) {
		default:
			...
			?>
				...
				<tr><td class="td1"><span class="norm"><b><?=$lng['ad_newsletter']['Who_is_the_newsletter_for']?></b><br><select name="target"><option value="1"><?=$lng['ad_newsletter']['All_members']?></option><option value="2"><?=$lng['ad_newsletter']['Only_moderators']?></option><option value="3"><?=$lng['ad_newsletter']['Only_administrators']?></option></select><br><b><?=$lng['ad_newsletter']['How_should_the_newsletter_be_sent']?></b><br><input type="radio" name="sendmethod" checked value="2"><?=$lng['ad_newsletter']['by_pm']?>  <input type="radio" name="sendmethod" value="1"> <?=$lng['ad_newsletter']['by_mail']?><br><b><?=$lng['ad_newsletter']['What_is_the_subject']?></b><br><input type="text" name="betreff" size="30"><br><b><?=$lng['ad_newsletter']['What_is_the_message']?></b><br><textarea name="newsletter" rows="8" cols="60"></textarea></span></td></tr>
