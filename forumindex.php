...
//
$forums_auth = array();
if($USER_LOGGED_IN == 1 && $USER_DATA['user_is_admin'] != 1 && $USER_DATA['user_is_supermod'] != 1) {
...
$NAVBAR->addElements('right',array($LNG['Mark_forums_read'],"index.php?faction=forumindex&amp;mark=all&amp;$MYSID"));
