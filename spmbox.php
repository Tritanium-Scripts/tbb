...
if($user_logged_in != 1) die('Function not available');
	...
	if($ungelesen == 0) $ungelesen = $lng['spmbox']['no_unread'];
	else $ungelesen = "<a class=\"small\" href=\"index.php?faction=pm$MYSID2\"><b>".sprintf($lng['spmbox']['x_unread'],$ungelesen)."</b></a>";
	?>
