...
add_navbar_items(array(myhtmlentities($forum_data['forum_name']),''));

//
// Seite ausgeben
//
include_once('pheader.php');
show_navbar('','',"<a href=\"index.php?faction=viewforum&amp;forum_id=$forum_id&amp;mark=all&amp;$MYSID\">".$lng['Mark_topics_read'].'</a>');
