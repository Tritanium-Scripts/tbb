...
<table class="tbl" cellpadding="{$modules.Config->getCfgVal('tpadding')}" cellspacing="{$modules.Config->getCfgVal('tspacing')}" style="width:{$modules.Config->getCfgVal('twidth')}; margin:auto;">
 <tr><th colspan="2" class="thnorm"><span class="thnorm">{$modules.Language->getString('add_new_special_user_right')}</span></th></tr>
 <tr>
  <td class="td1"><span class="norm" style="font-weight:bold;">{$modules.Language->getString('user_id_colon')}</span></td>
  <td class="td1"><input type="text" name="new_user_ids" /> <span class="small">{$modules.Language->getString('separate_ids_with_comma')}</span></td>
 </tr>
 <tr>
  <td class="td1" style="vertical-align:top;"><span class="norm" style="font-weight:bold;">{$modules.Language->getString('special_user_rights_colon')}</span></td>
  <td class="td1">
...
<p style="text-align:center;"><input type="submit" value="{$modules.Language->getString('add_new_special_user_right')}" /></p>
</form>