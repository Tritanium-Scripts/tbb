...
<p style="text-align:center;"><input type="submit" value="{Language::getInstance()->getString('update_template_configuration')}" />&nbsp;&nbsp;&nbsp;<input type="submit" name="testInstall" value="{Language::getInstance()->getString('test_template_installation')}" /></p>
