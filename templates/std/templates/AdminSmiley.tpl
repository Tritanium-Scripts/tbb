...
<p class="norm"><a class="norm" href="{$smarty.const.INDEXFILE}?faction=ad_smilies&amp;mode=new{$smarty.const.SID_AMPER}">{Language::getInstance()->getString('add_new_smiley')}</a></p>
...
<p class="norm"><a class="norm" href="{$smarty.const.INDEXFILE}?faction=ad_smilies&amp;mode=newa{$smarty.const.SID_AMPER}">{Language::getInstance()->getString('add_new_asmiley')}</a></p>
...
<p class="norm"><a class="norm" href="{$smarty.const.INDEXFILE}?faction=ad_smilies&amp;mode=newt{$smarty.const.SID_AMPER}">{Language::getInstance()->getString('add_new_post_icon')}</a></p>