...
{foreach $posts as $curPost}
 <tr>
  ...
  <td class="{cycle values="td1,td2" advance=false}" style="vertical-align:top; width:85%;">
   ...
   {if $curPost.canModify}&nbsp;<a href="{$smarty.const.INDEXFILE}?faction=edit&amp;forum_id={$forumID}&amp;topic_id={$topicID}&amp;post_id={$curPost.postID}{$smarty.const.SID_AMPER}"><img src="{$modules.Template->getTplDir()}images/edit.gif" alt="{$modules.Language->getString('edit')}" /></a> {$modules.Language->getString('edit')}{/if}
