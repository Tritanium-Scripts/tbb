...
<p style="text-align:center;"><input type="submit" value="{Language::getInstance()->getString('send_newsletter')}" />{plugin_hook hook=PlugIns::HOOK_TPL_ADMIN_NEWSLETTER_CONFIRM_BUTTONS}</p>
