...
<table class="tbl" cellpadding="{$modules.Config->getCfgVal('tpadding')}" cellspacing="{$modules.Config->getCfgVal('tspacing')}" style="width:{$modules.Config->getCfgVal('twidth')}; margin:auto;">
 ...
 <tr>
  <td class="td1" style="width:15%;"><span class="norm" style="font-weight:bold;">{$modules.Language->getString('from_colon')}</span>
  <td class="td1" style="width:85%;"><span class="norm">{$pm[3]}</span></td>
 </tr>
 <tr>
  <td class="td1" style="width:15%;"><span class="norm" style="font-weight:bold;">{$modules.Language->getString('date_colon')}</span>
  <td class="td1" style="width:85%;"><span class="norm">{$pm[4]}</span></td>
 </tr>
 <tr>
  <td class="td1" style="width:15%;"><span class="norm" style="font-weight:bold;">{$modules.Language->getString('subject_colon')}</span>
