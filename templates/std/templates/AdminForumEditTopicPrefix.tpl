...
<p style="text-align:center;"><input type="submit" value="{Language::getInstance()->getString('edit_topic_prefix')}" />{plugin_hook hook=PlugIns::HOOK_TPL_ADMIN_FORUM_EDIT_TOPIC_PREFIX_BUTTONS}</p>
