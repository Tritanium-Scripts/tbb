...
<p style="text-align:center;"><input type="submit" value="{Language::getInstance()->getString('send_mail')}" />{plugin_hook hook=PlugIns::HOOK_TPL_PROFILE_SEND_MAIL_BUTTONS}</p>
