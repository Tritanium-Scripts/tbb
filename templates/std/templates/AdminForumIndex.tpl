...
{foreach $forums as $curForum}
 <tr>
  ...
  <td class="td1" style="vertical-align:top;"><span class="small">{if count($curForum.mods) > 1}{', '|implode:$curForum.mods}{else}{$curForum.mods}{/if}</span></td>
  <td class="td2" style="vertical-align:top;"><span class="small">{$catTable[$curForum.catID]}</span></td>
...
{foreachelse}
 <tr><td class="td1" colspan="7" style="text-align:center;"><span class="norm" style="font-weight:bold;">{$modules.Language->getString('no_forums_available')}</span></td></tr>
{/foreach}
</table>
<p class="norm"><a class="norm" href="{$smarty.const.INDEXFILE}?faction=ad_forum&amp;mode=newforum{$smarty.const.SID_AMPER}">{$modules.Language->getString('add_new_forum')}</a></p>