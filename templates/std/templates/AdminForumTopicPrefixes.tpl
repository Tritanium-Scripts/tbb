...
{foreach $topicPrefixes as $curPrefix}
 <tr>
  ...
  <td class="td1"><span class="norm">{$curPrefix[2]}</span></td>
...
<p class="norm"><a class="norm" href="{$smarty.const.INDEXFILE}?faction=ad_forum&amp;mode=newTopicPrefix&amp;forum_id={$forumID}{$smarty.const.SID_AMPER}">{Language::getInstance()->getString('add_new_topic_prefix')}</a></p>