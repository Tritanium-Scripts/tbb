...
{foreach $groups as $curGroup}
 <tr>
  ...
  <td class="td1" style="vertical-align:top;"><span class="small">{if !empty($curGroup[3])}{', '|implode:$curGroup[3]}{else}{Language::getInstance()->getString('no_members')}{/if}</span></td>
...
{foreachelse}
 <tr><td colspan="4" class="td1" style="text-align:center;"><span class="norm" style="font-weight:bold;">{Language::getInstance()->getString('no_groups_available')}</span></td></tr>
{/foreach}
</table>
