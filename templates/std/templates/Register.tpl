...
<table class="tbl" cellpadding="{$modules.Config->getCfgVal('tpadding')}" cellspacing="{$modules.Config->getCfgVal('tspacing')}" style="width:{$modules.Config->getCfgVal('twidth')}; margin:auto;">
 ...
 <tr>
  ...
  <td class="td1" style="width:70%;"><input maxlength="15" type="text" name="newuser_name" value="{$newUser.nick}" /> <span class="small">{$modules.Language->getString('maximal_15_chars')}</span></td>
 ...
 <tr>
  ...
  <td class="td1" style="width:70%;"><input type="password" name="newuser_pw1" /></td>
 </tr>
 <tr>
  ...
  <td class="td1" style="width:70%;"><input type="password" name="newuser_pw2" /></td>
 </tr>{/if}
 <tr>
  ...
  <td class="td1" style="width:70%;"><input type="text" name="newuser_email" value="{$newUser.mail}" /></td>
 </tr>
 <tr>
  <td class="td1" style="font-weight:bold; width:30%;"><span class="norm">{$modules.Language->getString('homepage_colon')}</span></td>
  <td class="td1" style="width:70%;"><input type="text" name="newuser_hp" value="{$newUser.homepage}" /></td>
 </tr>
 <tr>
  <td class="td1" style="font-weight:bold; width:30%;"><span class="norm">{$modules.Language->getString('real_name_colon')}</span></td>
  <td class="td1" style="width:70%;"><input type="text" name="newuser_realname" value="{$newUser.realName}" /></td>
 </tr>
 <tr>
  <td class="td1" style="font-weight:bold; width:30%;"><span class="norm">{$modules.Language->getString('icq_number_colon')}</span></td>
  <td class="td1" style="width:70%;"><input type="text" name="newuser_icq" value="{$newUser.icq}" /></td>
 </tr>
 <tr>
  ...
  <td class="td1" style="width:70%;"><textarea cols="25" rows="6" name="newuser_signatur">{$newUser.signature}</textarea></td>
 </tr>
 <tr><td class="td1" colspan="2"><input type="checkbox" id="regeln" name="regeln" value="yes" style="vertical-align:middle;" /> <label for="regeln" class="norm">{sprintf($modules.Language->getString('i_accept_board_rules_denoted'), $smarty.const.INDEXFILE)}</label></td></tr>
</table>
