...
<p class="norm"><a class="norm" href="{$smarty.const.INDEXFILE}?faction=ad_rank&amp;mode=new{$smarty.const.SID_AMPER}">{Language::getInstance()->getString('add_new_rank')}</a>{plugin_hook hook=PlugIns::HOOK_TPL_ADMIN_RANK_RANKS_OPTIONS}</p>