...
<p style="text-align:center;"><input type="submit" value="{Language::getInstance()->getString('add_new_group')}" />{plugin_hook hook=PlugIns::HOOK_TPL_ADMIN_GROUP_NEW_GROUP_BUTTONS}</p>
