{* 0:nick - 1:id - 2:rankImage(s) - 3:mail - 4:rank - 5:posts - 6:regDate - 7:signature - 8:joinedXWeeksAgo - 9:hp - 10:avatar - 11:postsPerDay - 12:realName - 13:icq - 14:sendPM - 15:group - 16:timestamp *}
<!-- ViewProfile -->
<table class="tbl" cellpadding="{$modules.Config->getCfgVal('tpadding')}" cellspacing="{$modules.Config->getCfgVal('tspacing')}" style="width:{$modules.Config->getCfgVal('twidth')}; margin:auto;">
 <tr>
  <th class="thnorm"><span class="thnorm">{$modules.Language->getString('view_profile')}</span></th>
  <th class="thnorm" style="text-align:right;"><span class="thnorm"><a href="{$smarty.const.INDEXFILE}?faction=profile&amp;profile_id={$userData[1]}&amp;mode=vCard" style="color:yellow;">{$modules.Language->getString('download_as_vcard')}</a></span></th>
 </tr>
 <tr>
 ...
 <tr>
  ...
  <td class="td1" style="width:80%;"><span class="norm">{$userData[4]}&nbsp;{$userData[2]}</span></td>
 </tr>
 <tr>
