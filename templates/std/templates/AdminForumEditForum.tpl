...
{plugin_hook hook=PlugIns::HOOK_TPL_ADMIN_FORUM_EDIT_FORUM_FORM_START}
 ...
 <tr>
  ...
  <td class="td1"><input type="text" size="50" name="image" value="{$editImage}" /> <span class="small">{Language::getInstance()->getString('url_or_path')}</span></td>
 </tr>
 <tr>
  <td class="td1"><span class="norm" style="font-weight:bold;">{Language::getInstance()->getString('moderators_colon')}</span></td>
  <td class="td1"><input type="text" size="10" name="mods" value="{$editModIDs|join:','}" /> <span class="small">{Language::getInstance()->getString('separate_mod_ids_with_comma')}</span></td>
 </tr>
 <tr>
