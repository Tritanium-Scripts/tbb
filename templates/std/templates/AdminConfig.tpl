...
<table class="tbl" cellpadding="{Config::getInstance()->getCfgVal('tpadding')}" cellspacing="{Config::getInstance()->getCfgVal('tspacing')}" style="width:{Config::getInstance()->getCfgVal('twidth')}; margin:auto;">
 ...
 <tr>
  <td class="td1" colspan="2">
   <input type="checkbox" id="log1" name="settings[9][0]" value="{$smarty.const.LOG_FILESYSTEM}"{if $smarty.const.LOG_FILESYSTEM|in_array:$configValues['log_options']} checked="checked"{/if} /> <label for="log1" class="norm">{Language::getInstance()->getString('log_filesystem_problems')}</label><br />
   <input type="checkbox" id="log2" name="settings[9][1]" value="{$smarty.const.LOG_ACP_ACCESS}"{if $smarty.const.LOG_ACP_ACCESS|in_array:$configValues['log_options']} checked="checked"{/if} /> <label for="log2" class="norm">{Language::getInstance()->getString('log_failed_administration_access_attempts')}</label><br />
   <input type="checkbox" id="log3" name="settings[9][2]" value="{$smarty.const.LOG_FAILED_LOGIN}"{if $smarty.const.LOG_FAILED_LOGIN|in_array:$configValues['log_options']} checked="checked"{/if} /> <label for="log3" class="norm">{Language::getInstance()->getString('log_failed_logins')}</label><br />
   <input type="checkbox" id="log4" name="settings[9][3]" value="{$smarty.const.LOG_NEW_POSTING}"{if $smarty.const.LOG_NEW_POSTING|in_array:$configValues['log_options']} checked="checked"{/if} /> <label for="log4" class="norm">{Language::getInstance()->getString('log_new_posts')}</label><br />
   <input type="checkbox" id="log5" name="settings[9][4]" value="{$smarty.const.LOG_EDIT_POSTING}"{if $smarty.const.LOG_EDIT_POSTING|in_array:$configValues['log_options']} checked="checked"{/if} /> <label for="log5" class="norm">{Language::getInstance()->getString('log_posts_edited_deleted_etc')}</label><br />
   <input type="checkbox" id="log6" name="settings[9][5]" value="{$smarty.const.LOG_USER_CONNECT}"{if $smarty.const.LOG_USER_CONNECT|in_array:$configValues['log_options']} checked="checked"{/if} /> <label for="log6" class="norm">{Language::getInstance()->getString('log_users_connected_to_board')}</label><br />
   <input type="checkbox" id="log7" name="settings[9][6]" value="{$smarty.const.LOG_LOGIN_LOGOUT}"{if $smarty.const.LOG_LOGIN_LOGOUT|in_array:$configValues['log_options']} checked="checked"{/if} /> <label for="log7" class="norm">{Language::getInstance()->getString('log_login_and_logouts')}</label><br />
   <input type="checkbox" id="log8" name="settings[9][7]" value="{$smarty.const.LOG_ACP_ACTION}"{if $smarty.const.LOG_ACP_ACTION|in_array:$configValues['log_options']} checked="checked"{/if} /> <label for="log8" class="norm">{Language::getInstance()->getString('log_administration_actions')}</label><br />
   <input type="checkbox" id="log9" name="settings[9][8]" value="{$smarty.const.LOG_USER_TRAFFIC}"{if $smarty.const.LOG_USER_TRAFFIC|in_array:$configValues['log_options']} checked="checked"{/if} /> <label for="log9" class="norm">{Language::getInstance()->getString('log_pm_mail_traffic')}</label><br />
   <input type="checkbox" id="log10" name="settings[9][9]" value="{$smarty.const.LOG_EDIT_PROFILE}"{if $smarty.const.LOG_EDIT_PROFILE|in_array:$configValues['log_options']} checked="checked"{/if} /> <label for="log10" class="norm">{Language::getInstance()->getString('log_profiles_edited')}</label><br />
   <input type="checkbox" id="log11" name="settings[9][10]" value="{$smarty.const.LOG_REGISTRATION}"{if $smarty.const.LOG_REGISTRATION|in_array:$configValues['log_options']} checked="checked"{/if} /> <label for="log11" class="norm">{Language::getInstance()->getString('log_new_registrations')}</label><br />
   <input type="checkbox" id="log12" name="settings[9][11]" value="{$smarty.const.LOG_NEW_PASSWORD}"{if $smarty.const.LOG_NEW_PASSWORD|in_array:$configValues['log_options']} checked="checked"{/if} /> <label for="log12" class="norm">{Language::getInstance()->getString('log_new_passwords_sent')}</label><br />
  </td>
 </tr>
</table>
