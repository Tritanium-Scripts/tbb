...
<tr><td class="CellError"><span class="FontError"><img src="{$modules.Template->getTD()}/images/icons/Warning.png" alt="" class="ImageIcon"/>{$modules.Language->getString('board_rules_info')}</span></td></tr>
