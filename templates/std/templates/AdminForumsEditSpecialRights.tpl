...
<tr>
 ...
 <td class="CellTitle"><span class="FontTitleSmall">{$modules.Language->getString('auth_upload_files')}</span></td>
 <td class="CellTitle"><span class="FontTitleSmall">{$modules.Language->getString('auth_download_files')}</span></td>
...
<tr><td class="CellCat" colspan="10"><span class="FontCat">{$modules.Language->getString('user_rights')}</span></td></tr>
{foreach from=$rightsDataUsers item=curRight}
 <tr>
  ...
  <td class="CellStd" align="center"><input type="checkbox" name="p[rightsData][{$curRight.authID}][authUpload]" value="1"{if $curRight.authUpload == 1} checked="checked"{/if}/></td>
  <td class="CellStd" align="center"><input type="checkbox" name="p[rightsData][{$curRight.authID}][authDownload]" value="1"{if $curRight.authDownload == 1} checked="checked"{/if}/></td>
...
{/foreach}
<tr><td class="CellCat" colspan="10"><span class="FontCat">{$modules.Language->getString('group_rights')}</span></td></tr>
...
{/foreach}
<tr><td colspan="10" class="CellButtons" align="center"><input type="submit" class="FormBButton" value="{$modules.Language->getString('edit_special_rights')}"/>&nbsp;&nbsp;&nbsp;<input class="FormButton" type="reset" value="{$modules.Language->getString('reset')}"/></td></tr>
</table>
<br/>
<table class="TableStd" width="100%">
