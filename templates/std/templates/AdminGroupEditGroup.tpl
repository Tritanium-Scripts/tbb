...
{plugin_hook hook=PlugIns::HOOK_TPL_ADMIN_GROUP_EDIT_GROUP_FORM_START}
 ...
 <tr>
  ...
  <td class="td1" style="width:80%;"><input type="text" name="color" value="{$editColor}" style="color:{$editColor};" onchange="this.style.color = this.value;" /></td>
 </tr>
 <tr>
...
<p style="text-align:center;"><input type="submit" value="{Language::getInstance()->getString('edit_group')}" />{plugin_hook hook=PlugIns::HOOK_TPL_ADMIN_GROUP_EDIT_GROUP_BUTTONS}</p>
