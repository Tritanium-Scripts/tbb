...
{foreach $events as $curEvent}
 <tr>
  ...
  <td class="td1"><span class="norm">{$curEvent[3]|date_format:Language::getInstance()->getString('DATEFORMAT')}</span></td>
  <td class="td2"><span class="norm">{$curEvent[4]|date_format:Language::getInstance()->getString('DATEFORMAT')}</span></td>
