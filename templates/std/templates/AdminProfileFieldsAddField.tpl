<form method="post" action="{$smarty.const.INDEXFILE}?action=AdminProfileFields&amp;mode=AddField&amp;doit=1&amp;{$smarty.const.MYSID}">
...
<tr><td class="CellButtons" colspan="2" align="center"><input class="FormBButton" type="submit" value="{$modules.Language->getString('add_profile_field')}"/></td></tr>
</table>
</form>
