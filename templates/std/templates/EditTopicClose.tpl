...
<p style="text-align:center;"><input type="submit" value="{Language::getInstance()->getString('close_topic')}" />{plugin_hook hook=PlugIns::HOOK_TPL_POSTING_CLOSE_TOPIC_BUTTONS}</p>
