...
<p style="text-align:center;"><input type="submit" value="{Language::getInstance()->getString('add_new_rank')}" />{plugin_hook hook=PlugIns::HOOK_TPL_ADMIN_RANK_NEW_RANK_BUTTONS}</p>
