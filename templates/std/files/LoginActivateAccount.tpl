...
<tr>
 ...
 <td class="CellStd" width="85%"><input class="FormText" name="accountID" value="{$accountID}" size="25" />
</tr>
<tr>
 <td class="CellStd" width="15%"><span class="FontNorm">{$modules.Language->getString('Activation_code')}:</span></td>
 <td class="CellStd" width="85%"><input class="FormText" name="activationCode" value="{$activationCode}" size="35" maxlength="32" />
</tr>
