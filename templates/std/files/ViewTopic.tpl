   ...
   <tr>
    ...
    <td align="right">
     <table border="0" cellpadding="0" cellspacing="0">
      <tr>
       {if $curPost.show.deleteButton}<td><a href="{$indexFile}?action=DeletePost&amp;postID={$curPost.postID}&amp;{$mySID}"><img src="{$modules.Template->getTD()}/images/buttons/de/delete.png" class="ImageButton" alt="" border="0"/></a></td>{/if}
