...
<table class="tableStd" cellpadding="{Config::getInstance()->getCfgVal('tpadding')}" cellspacing="{Config::getInstance()->getCfgVal('tspacing')}" style="width:100%;">
 ...
 <tr>
  ...
  <td class="cellAlt">{{html_select_date prefix='' time=$newEventStartDate start_year='-5' end_year='+5' reverse_years=true field_array='eventStartDate' field_order=Language::getInstance()->getString('DATE_FIELD_ORDER') field_separator=Language::getInstance()->getString('DATE_SEPARATOR')}|utf8_encode} {html_select_time prefix='' time=$newEventStartDate field_array='eventStartDate'}</td>
 </tr>
 <tr>
  <td class="cellStd"><span class="fontNorm">{Language::getInstance()->getString('end')}</span></td>
  <td class="cellAlt">{{html_select_date prefix='' time=$newEventEndDate start_year='-5' end_year='+5' reverse_years=true field_array='eventEndDate' field_order=Language::getInstance()->getString('DATE_FIELD_ORDER') field_separator=Language::getInstance()->getString('DATE_SEPARATOR')}|utf8_encode} {html_select_time prefix='' time=$newEventEndDate field_array='eventEndDate'}</td>
 </tr>
 <tr>
