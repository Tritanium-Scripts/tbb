...
<table class="tableStd" cellpadding="{$modules.Config->getCfgVal('tpadding')}" cellspacing="{$modules.Config->getCfgVal('tspacing')}" style="width:100%;">
 <tr>
  <th class="cellTitle"><span class="fontTitle">{$modules.Language->getString('view_profile')}</span></th>
  <th class="cellTitle" style="text-align:right;"><span class="fontTitle"><a href="{$smarty.const.INDEXFILE}?faction=profile&amp;profile_id={$userData[1]}&amp;mode=vCard{$smarty.const.SID_AMPER}" style="color:yellow;"><img src="{$modules.Template->getTplDir()}images/icons/vcard.png" alt="" style="vertical-align:top;" /> {$modules.Language->getString('download_as_vcard')}</a></span></th>
 </tr>
 <tr>
 ...
 <tr><td class="td1" colspan="2"><span class="norm"><a class="norm" href="{$smarty.const.INDEXFILE}?faction=search&amp;search=yes&amp;age=0&amp;searchfor={$userData[1]}&amp;auswahl=all&amp;searchOption=user&amp;soption1=3{$smarty.const.SID_AMPER}">{$userData[0]|string_format:$modules.Language->getString('search_all_topics_from_x_brackets')}</a></span></td></tr>
