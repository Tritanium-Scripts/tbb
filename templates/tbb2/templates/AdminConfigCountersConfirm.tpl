...
<p class="cellButtons"><input class="formBButton" type="submit" value="{Language::getInstance()->getString('recalculate_counters')}" />{plugin_hook hook=PlugIns::HOOK_TPL_ADMIN_CONFIG_RECALCULATE_COUNTERS_BUTTONS}</p>
