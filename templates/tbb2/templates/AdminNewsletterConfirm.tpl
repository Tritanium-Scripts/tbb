...
{plugin_hook hook=PlugIns::HOOK_TPL_ADMIN_NEWSLETTER_CONFIRM_FORM_START}
 <tr>
...
{plugin_hook hook=PlugIns::HOOK_TPL_ADMIN_NEWSLETTER_CONFIRM_FORM_END}
</table>
<p class="cellButtons"><input class="formBButton" type="submit" value="{Language::getInstance()->getString('send_newsletter')}" />{plugin_hook hook=PlugIns::HOOK_TPL_ADMIN_NEWSLETTER_CONFIRM_BUTTONS}</p>
