...
<p class="cellButtons"><input class="formBButton" type="submit" value="{Language::getInstance()->getString('delete_post')}" />{plugin_hook hook=PlugIns::HOOK_TPL_POSTING_DELETE_POST_BUTTONS}</p>
