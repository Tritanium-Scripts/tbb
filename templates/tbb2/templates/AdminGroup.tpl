...
{foreach $groups as $curGroup}
 <tr>
  ...
  <td class="cellAlt" style="vertical-align:top;"><span class="fontSmall">{if !empty($curGroup[3])}{$curGroup[3]|join:', '}{else}{Language::getInstance()->getString('no_members')}{/if}</span></td>
