  ...
  <div id="headerBox">
   <div id="headerInnerBox">
    ...
    <div id="headerNavigationBox">{if $modules.Auth->isLoggedIn()}
     <a href="{$smarty.const.INDEXFILE}?faction=profile&amp;mode=edit&amp;profile_id={$modules.Auth->getUserID()}{$smarty.const.SID_AMPER}"><img src="{$modules.Template->getTplDir()}images/buttons/myprofile.png" class="imageButton" alt="{$modules.Language->getString('my_profile')}" /></a>
     ...
     <a href="{$smarty.const.INDEXFILE}?faction=mlist{$smarty.const.SID_AMPER}"><img src="{$modules.Template->getTplDir()}images/buttons/memberlist.png" class="imageButton" alt="{$modules.Language->getString('member_list')}" /></a>{/if}
     <a href="{$smarty.const.INDEXFILE}?faction=todaysPosts{$smarty.const.SID_AMPER}"><img src="{$modules.Template->getTplDir()}images/buttons/tposts.png" class="imageButton" alt="{$modules.Language->getString('todays_posts')}" /></a>
    ...
    <td class="cellNavBarBig">
     <table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
      <tr>
       ...
       <td style="text-align:right;"><span class="fontNavBar">{if $smarty.config.debug}&nbsp;{$action} &ndash; {$subAction}{/if}{if ($action == 'Forum' || $action == 'PostNew' || $action == 'Posting') && $subAction != 'ForumIndex' && $subAction != 'ViewTodaysPosts' && $subAction != 'Message'}<a href="{$smarty.const.INDEXFILE}?faction=newtopic&amp;forum_id={$forumID}{$smarty.const.SID_AMPER}"><img src="{$modules.Template->getTplDir()}images/buttons/newtopic.png" alt="" style="vertical-align:middle;" /></a>&nbsp;<a href="{$smarty.const.INDEXFILE}?faction=newpoll&amp;forum_id={$forumID}{$smarty.const.SID_AMPER}"><img src="{$modules.Template->getTplDir()}images/buttons/newpoll.gif" alt="" style="vertical-align:middle;" /></a>{if $subAction == 'ViewTopic'}&nbsp;<a href="{$smarty.const.INDEXFILE}?faction=reply&amp;forum_id={$forumID}&amp;thread_id={$topicID}{$smarty.const.SID_AMPER}"><img src="{$modules.Template->getTplDir()}images/buttons/newreply.png" alt="" style="vertical-align:middle;" /></a>{/if}{elseif $action == 'PrivateMessage' && $subAction != 'Message'}<a href="{$smarty.const.INDEXFILE}?faction=pm&amp;pmbox_id={$pmBoxID}&amp;mode=send{$smarty.const.SID_AMPER}"><img src="{$modules.Template->getTplDir()}images/buttons/newpm.png" alt="" style="vertical-align:middle;" /></a>{if $subAction == 'PrivateMessageViewPM' || $subAction == 'PrivateMessageConfirmDelete'}&nbsp;<a href="{$smarty.const.INDEXFILE}?faction=pm&amp;pmbox_id={$pmBoxID}&amp;mode=reply&amp;pm_id={$pmID}{$smarty.const.SID_AMPER}"><img src="{$modules.Template->getTplDir()}images/buttons/pmnewreply.png" alt="" style="vertical-align:middle;" /></a>&nbsp;<a href="{$smarty.const.INDEXFILE}?faction=pm&amp;pmbox_id={$pmBoxID}&amp;mode=kill&amp;pm_id={$pmID}{$smarty.const.SID_AMPER}"><img src="{$modules.Template->getTplDir()}images/buttons/pmdelete.png" alt="" style="vertical-align:middle;" /></a>{/if}{else}&nbsp;{/if}</span></td>
      </tr>
     </table>
    </td>
   </tr>
