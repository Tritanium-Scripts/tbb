...
<table class="tableStd" cellpadding="{$modules.Config->getCfgVal('tpadding')}" cellspacing="{$modules.Config->getCfgVal('tspacing')}" style="width:100%;">
 <tr><th colspan="2" class="cellTitle"><span class="fontTitle">{$modules.Language->getString('add_new_special_group_right')}</span></th></tr>
 <tr>
 ...
 <tr>
  <td class="cellStd" style="vertical-align:top;"><span class="fontNorm">{$modules.Language->getString('special_group_rights_colon')}</span></td>
  <td class="cellAlt">
...
<p class="cellButtons"><input class="formBButton" type="submit" value="{$modules.Language->getString('add_new_special_group_right')}" />&nbsp;&nbsp;&nbsp;<input class="formButton" type="reset" /></p>
