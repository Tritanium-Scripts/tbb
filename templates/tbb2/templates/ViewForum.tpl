...
{foreach $topics as $curTopic}
 <tr onmouseover="setRowCellsClass(this, 'cellHighlight');" onmouseout="restoreRowCellsClass(this);">
  <td class="cellAlt" style="text-align:center; width:20px;"><img src="{$modules.Template->getTplDir()}images/{$curTopic.topicIcon}.gif" alt="" /></td>
  ...
  <td class="cellNavBarBig">
   <table border="0" cellpadding="0" cellspacing="0" style="width:100%;">
    <tr>
     ...
     <td style="text-align:right;"><span class="fontNavBar"><a href="{$smarty.const.INDEXFILE}?faction=newtopic&amp;forum_id={$forumID}{$smarty.const.SID_AMPER}"><img src="{$modules.Template->getTplDir()}images/buttons/newtopic.png" alt="" style="vertical-align:middle;" /></a>&nbsp;<a href="{$smarty.const.INDEXFILE}?faction=newpoll&amp;forum_id={$forumID}{$smarty.const.SID_AMPER}"><img src="{$modules.Template->getTplDir()}images/buttons/newpoll.gif" alt="" style="vertical-align:middle;" /></a></span></td>
    </tr>
   </table>
  </td>
 </tr>
