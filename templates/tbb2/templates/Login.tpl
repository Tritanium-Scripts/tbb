...
<table class="tableStd" cellpadding="{Config::getInstance()->getCfgVal('tpadding')}" cellspacing="{Config::getInstance()->getCfgVal('tspacing')}" style="width:100%;">
 ...
 <tr><td colspan="2" class="cellStd"><input type="checkbox" id="stayli" name="stayli" value="yes" />&nbsp;<label for="stayli" class="fontNorm">{Language::getInstance()->getString('login_automatically_each_visit')}</label></td></tr>{if Config::getInstance()->getCfgVal('wio') == 1}
