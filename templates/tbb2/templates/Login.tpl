...
<table class="tableStd" cellpadding="{$modules.Config->getCfgVal('tpadding')}" cellspacing="{$modules.Config->getCfgVal('tspacing')}" style="width:100%;">
 ...
 <tr><td colspan="2" class="cellStd"><input type="checkbox" id="stayli" name="stayli" value="yes" />&nbsp;<label for="stayli" class="fontNorm">{$modules.Language->getString('login_automatically_each_visit')}</label></td></tr>{if $modules.Config->getCfgVal('wio') == 1}
 <tr><td colspan="2" class="cellStd"><input type="checkbox" id="bewio" name="bewio" value="yes" />&nbsp;<label for="bewio" class="fontNorm">{$modules.Language->getString('hide_from_wiwo')}</label></td></tr>{/if}
</table>
