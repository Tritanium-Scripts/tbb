...
{plugin_hook hook=PlugIns::HOOK_TPL_LOGIN_FORM_START}
 <tr>
...
{plugin_hook hook=PlugIns::HOOK_TPL_LOGIN_FORM_END}
...
<p class="cellButtons"><input class="formBButton" type="submit" value="{Language::getInstance()->getString('login')}" />{plugin_hook hook=PlugIns::HOOK_TPL_LOGIN_BUTTONS}</p>
</form>