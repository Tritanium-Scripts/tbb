...
<table class="tableStd" cellpadding="{$modules.Config->getCfgVal('tpadding')}" cellspacing="{$modules.Config->getCfgVal('tspacing')}" style="width:100%;">
 ...
 <tr><td class="divInfoBox" colspan="2"><span class="fontInfoBox"><img src="{$modules.Template->getTplDir()}images/icons/info.png" alt="" class="imageIcon" /> {$modules.Language->getString('create_new_password')|string_format:$modules.Language->getString('request_new_password_info')}</span></td></tr>
</table>
