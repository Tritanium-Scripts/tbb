...
{plugin_hook hook=PlugIns::HOOK_TPL_ADMIN_RANK_NEW_RANK_FORM_START}
 <tr>
...
{plugin_hook hook=PlugIns::HOOK_TPL_ADMIN_RANK_NEW_RANK_FORM_END}
</table>
<p class="cellButtons"><input class="formBButton" type="submit" value="{Language::getInstance()->getString('add_new_rank')}" />&nbsp;&nbsp;&nbsp;<input class="formButton" type="reset" />{plugin_hook hook=PlugIns::HOOK_TPL_ADMIN_RANK_NEW_RANK_BUTTONS}</p>
