...
<table class="tableStd" cellpadding="{$modules.Config->getCfgVal('tpadding')}" cellspacing="{$modules.Config->getCfgVal('tspacing')}" style="width:100%;">
 ...
 <tr><th class="cellTitle" colspan="2"><span class="fontTitle">{$modules.Language->getString('delete_old_topics')}</span></th></tr>
 <tr>
  <td class="cellStd"><span class="fontNorm">{$modules.Language->getString('forum_colon')}</span></td>
  <td class="cellAlt">
 ...
 <tr>
  <td class="cellStd"><span class="fontNorm">{$modules.Language->getString('delete_topics_older_than_colon')}</span></td>
 ...
 <tr><td class="cellInfoBox" colspan="2" style="font-weight:bold;"><span class="fontNorm"><img src="{$modules.Template->getTplDir()}images/icons/info.png" alt="" class="imageIcon" /> {$modules.Language->getString('delete_warning')}</span></td></tr>
</table>
<p class="cellButtons"><input class="formBButton" type="submit" value="{$modules.Language->getString('delete_old_topics')}" /></p>
