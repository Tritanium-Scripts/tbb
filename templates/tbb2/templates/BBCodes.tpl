<!-- BBCodes -->
<input class="formBBCodeButton" style="font-weight:bold;" type="button" value="B" onclick="setTag('[b]','[/b]');" />
<input class="formBBCodeButton" style="font-style:italic;" type="button" value="I" onclick="setTag('[i]','[/i]');" />
<input class="formBBCodeButton" style="text-decoration:underline;" type="button" value="U" onclick="setTag('[u]','[/u]');" />
<input class="formBBCodeButton" style="text-decoration:line-through;" type="button" value="S" onclick="setTag('[s]','[/s]');" />
<input class="formBBCodeButton" type="button" value="{Language::getInstance()->getString('center', 'BBCode')}" onclick="setTag('[center]','[/center]');" />
<button class="formBBCodeButton" type="button" onclick="setTag('[sup]','[/sup]');"><span style="position:relative; top:-0.3em;">{Language::getInstance()->getString('superscript')}</span></button>
<button class="formBBCodeButton" type="button" onclick="setTag('[sub]', '[/sub]');"><span style="position:relative; bottom:-0.3em;">{Language::getInstance()->getString('subscript')}</span></button>
<input class="formBBCodeButton" type="button" value="{Language::getInstance()->getString('quote_quoted')}" onclick="setTag('[quote]','[/quote]');" />
<input class="formBBCodeButton" style="font-family:monospace;" type="button" value="{Language::getInstance()->getString('code')}" onclick="setTag('[code]','[/code]');" />
...
<input class="formBBCodeButton" type="button" value="{Language::getInstance()->getString('upload_file')}" onclick="window.open('{$smarty.const.INDEXFILE}?faction=uploadFile&amp;targetBoxID={$targetBoxID}', '_blank', 'width=500,height=400, status');" />{/if}<br />
...
<input class="formBBCodeButton" type="button" value="{Language::getInstance()->getString('email')}" onclick="setTag('[email]','[/email]');" />
<input class="formBBCodeButton" type="button" value="{Language::getInstance()->getString('bullet_list')}" onclick="setTag('[list]\n[*]','\n[/list]');" />
