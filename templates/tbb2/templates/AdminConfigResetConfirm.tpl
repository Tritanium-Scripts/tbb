...
<p class="cellButtons"><input class="formBButton" type="submit" value="{Language::getInstance()->getString('reset_settings')}" />{plugin_hook hook=PlugIns::HOOK_TPL_ADMIN_CONFIG_RESET_SETTINGS_BUTTONS}</p>
