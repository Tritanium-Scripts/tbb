...
{if count($logfiles) > 0}<p class="cellButtons"><input class="formBButton" type="submit" name="multiDelete" value="{Language::getInstance()->getString('delete_selected_logfiles')}" /></p>{/if}
</form>
