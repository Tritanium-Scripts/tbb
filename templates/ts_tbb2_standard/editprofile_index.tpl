...
<template:avatarrow>
<tr><td class="cat" colspan="2"><span class="cat">{avatarrow.$lng['Avatar']}</span></td></tr>
<tr>
 <td class="td1" width="25%" valign="top"><span class="norm">{avatarrow.$lng['Avatar_address']}:</span><br /><span class="small">{avatarrow.$lng['Path_or_url']}</span></td>
 <td class="td2" width="75%" valign="top"><input class="form_text" type="text" name="p_avatar_address" value="{avatarrow.$p_avatar_address}" size="40" /><br /><span class="small"><a href="javascript:popup('index.php?faction=editprofile&amp;mode=selectavatar&amp;{avatarrow.$MYSID}','selectavatarwindow','width=400,height=200,scrollbars=yes,toolbar=no')">{avatarrow.$lng['Select_avatar_from_list']}</a><br /><a href="javascript:popup('index.php?faction=editprofile&amp;mode=uploadavatar&amp;{avatarrow.$MYSID}','uploadavatarwindow','width=500,height=250,scrollbars=yes,toolbar=no,status=yes')">{avatarrow.$lng['Upload_avatar']}</a></span></td>
</tr>
</template:avatarrow>
