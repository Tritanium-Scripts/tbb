...
<tr><th class="thnorm" colspan="2"><span class="thnorm">{$lng['Add_user_right']}</span></th></tr>
<tr>
 <td class="td1"><span class="norm">{$lng['Users']}:</span></td>
 <td class="td1"><input type="text" class="form_text" name="p_users" value="{$p_users}" size="30" /></td>
</tr>
<tr>
 <td class="td2" valign="top"><span class="norm">{$lng['Rights']}:</span></td>
 <td class="td2"><span class="norm">
...
<tr><td class="buttonrow" colspan="2" align="center"><input type="submit" class="form_bbutton" value="{$lng['Add_user_right']}" />&nbsp;&nbsp;&nbsp;<input type="reset" class="form_button" value="{$lng['Reset']}" /></td></tr>
</table>
</form>