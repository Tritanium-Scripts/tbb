...
<!-- TPLBLOCK topicrow -->
 <tr>
  ...
  <td class="td1" align="center"><span class="small">{topicrow.$akt_topic_data["topic_replies"]}</span></td>
  <td class="td2" align="center"><span class="small">{topicrow.$akt_topic_data["topic_views"]}</span></td>
