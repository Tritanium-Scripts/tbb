<form method="post" action="administration.php?faction=ad_profile&amp;mode=editfield&amp;field_id={$field_id}&amp;doit=1&amp;{$MYSID}">
<table class="tablestd" border="0" cellpadding="3" cellspacing="0" width="100%">
<tr><td class="celltitle" colspan="2"><span class="fonttitle">{$LNG['Edit_profile_field']}</span></td></tr>
<tr>
...
<tr>
 <td class="cellstd" width="20%"><span class="fontnorm">{$LNG['Field_link']}:</span><br /><span class="fontsmall">{$LNG['field_link_info']}</span></td>
 <td class="cellalt" width="80%" valign="top"><input class="form_text" type="text" size="50" name="p_field_link" value="{$p_field_link}" /></td>
</tr>
<tr>
...
<tr><td class="cellbuttons" colspan="2" align="center"><input class="form_bbutton" type="submit" value="{$LNG['Edit_profile_field']}" />&nbsp;&nbsp;&nbsp;<input class="form_button" type="reset" value="{$LNG['Reset']}" /></td></tr>
</table>
</form>
