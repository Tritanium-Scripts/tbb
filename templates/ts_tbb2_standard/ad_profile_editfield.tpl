...
<tr><th class="thnorm" colspan="2"><span class="thnorm">{$lng['Edit_profile_field']}</span></th></tr>
<tr>
...
<tr><td class="buttonrow" colspan="2" align="center"><input class="form_bbutton" type="submit" value="{$lng['Edit_profile_field']}" />&nbsp;&nbsp;&nbsp;<input class="form_button" type="reset" value="{$lng['Reset']}" /></td></tr>
</table>
</form>
