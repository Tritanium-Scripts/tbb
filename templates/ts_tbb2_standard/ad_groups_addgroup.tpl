...
<tr><td class="celltitle" colspan="2"><span class="fonttitle">{$LNG['Add_group']}</span></td></tr>
<template:errorrow>
...
<tr><td class="cellbuttons" align="center" colspan="2"><input class="form_bbutton" type="submit" value="{$LNG['Add_group']}" />&nbsp;&nbsp;&nbsp;<input class="form_button" type="reset" value="{$LNG['Reset']}" /></td></tr>
</table>
</form>