...
<tr><td class="celltitle" colspan="2"><span class="fonttitle">{$LNG['View_private_message']}</span></td></tr>
<tr>
 <td class="cellalt" width="15%"><span class="fontnorm">{$LNG['Date']}:</span></td>
 <td class="cellalt" width="85%"><span class="fontnorm">{$pm_send_date}</span></td>
</tr>
<tr>
 <td class="cellalt" width="15%" style="border-bottom:black 1px solid;"><span class="fontnorm">{$LNG['Subject']}:</span></td>
 <td class="cellalt" width="85%" style="border-bottom:black 1px solid;"><span class="fontnorm"><b>{$pm_data['pm_subject']}</b> {$pm_sender}</span></td>
</tr>
<tr><td class="cellstd" colspan="2"><span class="fontnorm">{$pm_data['pm_text']}</span></td></tr>
</table>
<template:replyform>
<br />
<form method="post" action="index.php?faction=pms&amp;mode=viewpm&amp;pm_id={$pm_id}&amp;doit=1&amp;{$MYSID}" name="tbb_form">
<table class="tablestd" border="0" cellpadding="3" cellspacing="0" width="100%">
<tr><td class="celltitle" colspan="2"><span class="fonttitle">{$LNG['Reply']}</span></td></tr>
<template:errorrow>
