...
<tr><th class="thnorm" colspan="2"><span class="thnorm">{LNG_EDIT_FORUM}</span></th></tr>
<!-- TPLBLOCK errorrow -->
...
<tr><td colspan="2" class="td1"><span class="norm">
 ...
 <input type="checkbox" name="p_guests_post_poll" value="1"{C_GUESTS_POST_POLL} /> {LNG_GUESTS_POST_POLL}<br />
 <a href="administration.php?faction=ad_forums&amp;mode=editsrights&amp;forum_id={FORUM_ID}&amp;{MYSID}">{LNG_EDIT_SPECIAL_RIGTHS}</a>
</span></td></tr>
...
<tr><td colspan="2" class="buttonrow" align="center"><input type="submit" class="form_bbutton" value="{LNG_EDIT_FORUM}" />&nbsp;&nbsp;&nbsp;<input class="form_button" type="reset" value="{LNG_RESET}" /></td></tr>
</table>
</form>