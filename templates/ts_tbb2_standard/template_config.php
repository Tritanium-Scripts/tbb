...
$tpl_config['smiliesbox_maximum_smilies'] = 24; // Maximale Anzahl an Smilies in der Kurzübersicht z.B. beim Antworten
$tpl_config['viewsmilies_smilies_per_row'] = 10; // Anzahl der Smilies pro Reihe in der Gesamtübersicht aller Smilies
...
//
// Name (und eventuell Verzeichnis) der benötigten Bilder
//
...
//
// Namen (und eventuell Verzeichnis) der Templatedateien für die verschiedenen Bereiche
//
...
$tpl_config['tpl_editprofile'] = 'editprofile.tpl';
...
$tpl_config['tpl_register'] = 'register.tpl';
