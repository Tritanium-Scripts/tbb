...
<template:postrow>
 <tr>
  <td rowspan="2" class="{postrow.$tpl_config['akt_class']}" width="15%" valign="top"><span class="norm"><b>{postrow.$akt_poster_nick}</b></span><br /><span class="small">{postrow.$akt_poster_rank_text}<br />{postrow.$akt_poster_rank_pic}<br />{postrow.$akt_poster_id}<br /><br />{postrow.$akt_poster_avatar}<br /><br /></span></td>
  <td class="{postrow.$tpl_config['akt_class']}" width="85%" valign="top">
   ...
   <span class="norm">{postrow.$akt_post['post_text']}</span>
   <template:postrow.signature>
   <br /><br /><span class="signature">-----------<br />{postrow.signature.$akt_post_signature}</span>
   </template:postrow.signature>
   <p><span class="small">{postrow.$akt_edited_text}</span></p>
  </td>
 </tr>
