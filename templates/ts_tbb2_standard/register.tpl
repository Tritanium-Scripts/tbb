...
<!-- TPLBLOCK userpw -->
<tr>
 <td class="td1" width="25%" valign="top"><span class="norm">{userpw.$lng["Password"]}:*</span></td>
 <td class="td2" width="75%" valign="top"><span class="norm"><input class="form_text" type="password" name="p_pw1" size="20" /></span></td>
</tr>
<tr>
 <td class="td1" width="25%" valign="top"><span class="norm">{userpw.$lng["Confirm_password"]}:*</span></td>
