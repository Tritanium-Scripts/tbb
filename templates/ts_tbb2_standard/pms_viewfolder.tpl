...
<tr><td valign="top" width="20%">
 ...
 <template:folderrow>
  <tr><td class="td1"><span class="small"><a href="index.php?faction=pms&amp;mode=viewfolder&amp;folder_id={$akt_folder['folder_id']}&amp;{$MYSID}">{$akt_folder['folder_name']}</a></td></tr>
 </template>
 </table>
</td>
<td valign="top">
 ...
 <template:pmrow>
  <tr>
   <td class="td1" align="center"><input type="checkbox" value="{$akt_pm['pm_id']}" name="pm_ids[]" /></td>
   <td class="td2"><span class="norm"><a href="index.php?faction=pms&amp;mode=viewpm&amp;pm_id={$akt_pm['pm_id']}&amp;{$MYSID}">{$akt_pm['pm_subject']}</a></span></td>
   <td class="td1" align="center"><span class="small">{$akt_date}</span></td>
   <td class="td2"><span class="small">{$akt_sender}</span></td>
   <td class="td1" align="right"><span class="small"><a href="index.php?faction=pms&amp;mode=deletepms&amp;pm_id={$akt_pm['pm_id']}&amp;{$MYSID}">{$lng['delete']}</a></span></td>
  </tr>
 </template>
 <template:nopms>
  <tr><td class="td1" colspan="5" align="center"><span class="norm">-- {$lng['No_messages_in_this_folder']} --</span></td></tr>
 </template>
