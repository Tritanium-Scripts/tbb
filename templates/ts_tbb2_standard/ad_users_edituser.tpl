...
<tr>
 ...
 <td class="cellalt" width="80%" valign="top"><span class="fontnorm"><input type="checkbox" name="p_user_is_admin" value="1"{$checked['isadmin']} />&nbsp;{$LNG['User_is_admin']}<br /><input type="checkbox" name="p_user_is_supermod" value="1"{$checked['issupermod']} />&nbsp;{$LNG['User_is_supermod']}</span></td>
</tr>
