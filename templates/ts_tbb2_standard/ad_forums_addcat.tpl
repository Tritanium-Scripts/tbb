...
<tr><th class="thnorm" colspan="2"><span class="thnorm">{LNG_ADD_CATEGORY}</span></th></tr>
<!-- TPLBLOCK errorrow -->
...
<tr>
 ...
 <td class="td1" width="85%"><select name="form_select" name="p_parent_id">
 <!-- TPLBLOCK optionrow -->
  <option value="{optionrow.VALUE}"{optionrow.SELECTED}>{optionrow.TEXT}</option>
 <!-- /TPLBLOCK optionrow -->
 </select></td>
</tr>
<tr><td colspan="2" class="buttonrow" align="center"><input type="submit" class="form_bbutton" value="{LNG_ADD_CATEGORY}" />&nbsp;&nbsp;&nbsp;<input class="form_button" type="reset" value="{LNG_RESET}" /></td></tr>
</table>
</form>