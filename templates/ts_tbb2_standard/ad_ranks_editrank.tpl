...
<tr><th class="thnorm" colspan="2"><span class="thnorm">{$lng['Edit_rank']}</span></td></tr>
<template:errorrow>
...
<tr><td class="buttonrow" colspan="2" align="center"><input class="form_bbutton" type="submit" value="{$lng['Edit_rank']}" />&nbsp;&nbsp;&nbsp;<input class="form_button" type="reset" value="{$lng['Reset']}" /></td></tr>
</table>
</form>
