...
<tr>
 ...
 <td class="cellalt" width="75%" valign="top"><input class="form_text" type="text" name="p_user_name" value="{$p_user_name}" size="20" /></td>
</tr>
<tr>
...
<tr>
 ...
 <td class="cellalt" width="75%" valign="top"><span class="fontnorm"><input type="checkbox" name="p_notify_user" value="1"{$checked['notify']} />&nbsp;{$LNG['Notify_user_registration']}</span></td>
</tr>
