...
<tr>
 <td class="cellalt"><span class="fontnorm">{$LNG['Profile_notes']}:</span></td>
 <td class="cellalt"><select class="form_select" name="p_config[allow_profile_notes]"><option value="1"{$checked['allow_profile_notes'][1]}>{$LNG['Usage_without_permission']}</option><option value="0"{$checked['allow_profile_notes'][0]}>{$LNG['Usage_only_with_permission']}</option></select></td>
</tr>
...
<tr>
 <td class="cellalt"><span class="fontnorm">{$LNG['Enable_language_detection']}:</span></td>
 <td class="cellalt"><select class="form_select" name="p_config[use_language_detection]"><option value="1"{$checked['use_language_detection'][1]}>{$LNG['Yes']}</option><option value="0"{$checked['use_language_detection'][0]}>{$LNG['No']}</option></select></td>
</tr>
<tr>
 <td class="cellalt"><span class="fontnorm">{$LNG['Allow_members_select_language']}:</span></td>
...
<tr>
 <td class="cellalt"><span class="fontnorm">{$LNG['Allow_guests_select_language']}:</span></td>
 <td class="cellalt"><select class="form_select" name="p_config[allow_select_lng_guests]"><option value="1"{$checked['allow_select_lng_guests'][1]}>{$LNG['Yes']}</option><option value="0"{$checked['allow_select_lng_guests'][0]}>{$LNG['No']}</option></select></td>
</tr>
