...
<tr>
 <td class="td2"><span class="norm">{$lng['Board_name']}:</span></td>
 <td class="td2"><input size="25" class="form_text" type="text" value="{$p_config['board_name']}" name="p_config[board_name]" /></td>
</tr>
<tr>
 <td class="td1" valign="top"><span class="norm">{$lng['Board_address']}:</span><br /><span class="small">{$lng['board_address_info']}</span></td>
 <td class="td1" valign="top"><input size="50" class="form_text" type="text" value="{$p_config['board_address']}" name="p_config[board_address]" /></td>
</tr>
<tr>
 <td class="td2" valign="top"><span class="norm">{$lng['Path_to_forum']}:</span><br /><span class="small">{$lng['path_to_forum_info']}</span></td>
 <td class="td2" valign="top"><input size="50" class="form_text" type="text" value="{$p_config['path_to_forum']}" name="p_config[path_to_forum]" /></td>
</tr>
<tr>
...
<tr>
 <td class="td1"><span class="norm">{$lng['Standard_timezone']}:</span></td>
 <td class="td1"><select class="form_select" name="p_config[standard_tz]">
 <template:tzrow>
...
<tr>
 <td class="td1"><span class="norm">{$lng['Enable_email_formular']}:</span><br /><span class="small">{$lng['email_formular_info']}</span></td>
 <td class="td1"><select class="form_select" name="p_config[enable_email_formular]"><option value="1"{$checked['enable_email_formular'][1]}>{$lng['Yes']}</option><option value="0"{$checked['enable_email_formular'][0]}>{$lng['No']}</option></select></td>
</tr>
<tr><td class="cat" colspan="2"><span class="cat">{$lng['News_settings']}</span></td></tr>
<tr>
 <td class="td1"><span class="norm">{$lng['News_forum']}:</span></td>
 <td class="td1"><select class="form_select" name="p_config[news_forum]">
...
<tr>
 <td class="td2"><span class="norm">{$lng['Display_news_forumindex']}:</span></td>
 <td class="td2"><select class="form_select" name="p_config[show_news_forumindex]"><option value="1"{$checked['show_news_forumindex'][1]}>{$lng['Yes']}</option><option value="0"{$checked['show_news_forumindex'][0]}>{$lng['No']}</option></select></td>
</tr>
<tr>
 <td class="td1"><span class="norm">{$lng['Enable_news_module']}:</span><br /><span class="small">{$lng['news_module_info']}</span></td>
 <td class="td1"><select class="form_select" name="p_config[enable_news_module]"><option value="1"{$checked['enable_news_module'][1]}>{$lng['Yes']}</option><option value="0"{$checked['enable_news_module'][0]}>{$lng['No']}</option></select></td>
</tr>
...
<tr>
 <td class="td2"><span class="norm">{$lng['Enable_avatar_upload']}:</span></td>
 <td class="td2"><select class="form_select" name="p_config[enable_avatar_upload]"><option value="1"{$checked['enable_avatar_upload'][1]}>{$lng['Yes']}</option><option value="0"{$checked['enable_avatar_upload'][0]}>{$lng['No']}</option></select></td>
</tr>
<tr>
