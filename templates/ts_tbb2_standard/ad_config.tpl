...
<tr>
 ...
 <td class="td1"><select class="form_select" name="p_config[enable_pms]"><option value="1"{$checked["enable_pms_1"]}>{$lng["Yes"]}</option><option value="0"{$checked["enable_pms_0"]}>{$lng["No"]}</option></select></td>
</tr>
<tr>
...
<tr>
 ...
 <td class="td2"><select class="form_select" name="p_config[allow_pms_signature]"><option value="1"{$checked["allow_pms_signature_1"]}>{$lng["Yes"]}</option><option value="0"{$checked["allow_pms_signature_0"]}>{$lng["No"]}</option></select></td>
</tr>
<tr>
 <td class="td1"><span class="norm">{$lng["Allow_pms_smilies"]}:</span></td>
 <td class="td1"><select class="form_select" name="p_config[allow_pms_smilies]"><option value="1"{$checked["allow_pms_smilies_1"]}>{$lng["Yes"]}</option><option value="0"{$checked["allow_pms_smilies_0"]}>{$lng["No"]}</option></select></td>
</tr>
<tr>
 <td class="td2"><span class="norm">{$lng["Allow_pms_bbcode"]}:</span></td>
 <td class="td2"><select class="form_select" name="p_config[allow_pms_bbcode]"><option value="1"{$checked["allow_pms_bbcode_1"]}>{$lng["Yes"]}</option><option value="0"{$checked["allow_pms_bbcode_0"]}>{$lng["No"]}</option></select></td>
</tr>
<tr>
 <td class="td1"><span class="norm">{$lng["Allow_pms_htmlcode"]}:</span></td>
 <td class="td1"><select class="form_select" name="p_config[allow_pms_htmlcode]"><option value="1"{$checked["allow_pms_htmlcode_1"]}>{$lng["Yes"]}</option><option value="0"{$checked["allow_pms_htmlcode_0"]}>{$lng["No"]}</option></select></td>
</tr>
<tr>
 <td class="td2"><span class="norm">{$lng["Enable_outbox"]}:</span></td>
 <td class="td2"><select class="form_select" name="p_config[enable_outbox]"><option value="1"{$checked["enable_outbox_1"]}>{$lng["Yes"]}</option><option value="0"{$checked["enable_outbox_0"]}>{$lng["No"]}</option></select></td>
</tr>
...
<tr>
 ...
 <td class="td1"><select class="form_select" name="p_config[enable_gzip]"><option value="1"{$checked["enable_gzip_1"]}>{$lng["Yes"]}</option><option value="0"{$checked["enable_gzip_0"]}>{$lng["No"]}</option></select></td>
</tr>
