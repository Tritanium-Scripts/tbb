...
<tr>
 ...
 <td class="td2" width="75%"><input class="form_text" type="password" name="p_pw" tabindex="2" /> <span class="small">(<a href="index.php?faction=requestpassword&amp;{$MYSID}" tabindex="4">{$lng['Request_new_password']}</a>)</span></td>
</tr>
