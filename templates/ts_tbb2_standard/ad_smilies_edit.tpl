<form method="post" action="administration.php?faction=ad_smilies&amp;mode=edit&amp;smiley_id={$smiley_id}&amp;doit=1&amp;{$MYSID}">
<table class="tablestd" cellpadding="3" cellspacing="0" border="0" width="100%">
<tr><td class="celltitle" colspan="2"><span class="fonttitle">{$LNG['Edit_smiley_topic_pic']}</span></td></tr>
<if:"{$error} != ''">
...
<tr><td class="cellbuttons" colspan="2" align="center"><input class="form_bbutton" type="submit" value="{$LNG['Edit_smiley_topic_pic']}" />&nbsp;&nbsp;&nbsp;<input class="form_button" type="reset" value="{$LNG['Reset']}" /></td></tr>
</table>
</form>
