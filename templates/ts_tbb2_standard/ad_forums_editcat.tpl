...
<tr><td class="celltitle" colspan="2"><span class="fonttitle">{$LNG['Edit_category']}</span></td></tr>
<template:errorrow>
...
<tr><td colspan="2" class="cellbuttons" align="center"><input type="submit" class="form_bbutton" value="{$LNG['Edit_category']}" />&nbsp;&nbsp;&nbsp;<input class="form_button" type="reset" value="{$LNG['Reset']}" /></td></tr>
</table>
</form>