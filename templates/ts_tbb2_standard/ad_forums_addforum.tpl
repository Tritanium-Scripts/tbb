...
<tr><td class="celltitle" colspan="2"><span class="fonttitle">{$LNG['Add_forum']}</span></td></tr>
<template:errorrow>
...
<tr><td colspan="2" class="cellbuttons" align="center"><input type="submit" class="form_bbutton" value="{$LNG['Add_forum']}" />&nbsp;&nbsp;&nbsp;<input class="form_button" type="reset" value="{$LNG['Reset']}" /></td></tr>
</table>
</form>