...
<tr><th class="thnorm" colspan="2"><span class="thnorm">{$lng['Add_avatar']}</span></th></tr>
<template:errorrow>
...
<tr><td class="buttonrow" colspan="2" align="center"><input class="form_bbutton" type="submit" value="{$lng['Add_avatar']}" />&nbsp;&nbsp;&nbsp;<input class="form_button" type="reset" value="{$lng['Reset']}" /></td></tr>
</table>
</form>
