...
<template:topicrow>
 <tr>
  <td class="td1"><span class="norm">{topicrow.$akt_topic_prefix}</span><span class="topiclink"><a href="index.php?faction=viewtopic&amp;topic_id={topicrow.$akt_topic_data['topic_id']}&amp;{topicrow.$MYSID}">{topicrow.$akt_topic_data['topic_title']}</a></span></td>
  <td class="td2" align="center"><span class="norm"><a href="index.php?faction=viewprofile&amp;profile_id={topicrow.$akt_topic_data['poster_id']}&amp;{topicrow.$MYSID}">{topicrow.$akt_topic_data['poster_nick']}</a></span></td>
